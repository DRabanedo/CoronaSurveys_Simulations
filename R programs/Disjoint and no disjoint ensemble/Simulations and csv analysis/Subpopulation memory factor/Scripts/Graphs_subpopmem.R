...
if(ncol(Nh_PIMLE_dataframe_disjoint) !=  0) {
  graph_data_abserror_disjoint = cbind(graph_data_abserror_disjoint, Nh_PIMLE =  Nh_PIMLE_analysis_disjoint$abs_error)
}

#if(ncol(Nh_PIMLEvis_dataframe_disjoint) !=  0) {
#  graph_data_abserror_disjoint = cbind(graph_data_abserror_disjoint, Nh_PIMLEvis =  Nh_PIMLEvis_analysis_disjoint$abs_error)
#}
...
if(ncol(Nh_MLE_dataframe_disjoint) !=  0) {
  graph_data_abserror_disjoint = cbind(graph_data_abserror_disjoint, Nh_MLE =  Nh_MLE_analysis_disjoint$abs_error)
}

#if(ncol(Nh_MLEvis_dataframe_disjoint) !=  0) {
#  graph_data_abserror_disjoint = cbind(graph_data_abserror_disjoint, Nh_MLEvis =  Nh_MLEvis_analysis_disjoint$abs_error)
#}
...
if(ncol(Nh_MoS_dataframe_disjoint) !=  0) {
  graph_data_abserror_disjoint = cbind(graph_data_abserror_disjoint, Nh_MoS =  Nh_MoS_analysis_disjoint$abs_error)
}

#if(ncol(Nh_MoSvis_dataframe_disjoint) !=  0) {
#  graph_data_abserror_disjoint = cbind(graph_data_abserror_disjoint, Nh_MoSvis =  Nh_MoSvis_analysis_disjoint$abs_error)
#}



if(ncol(Nh_GNSUM_dataframe_disjoint) !=  0) {
  graph_data_abserror_disjoint = cbind(graph_data_abserror_disjoint, Nh_GNSUM  =  Nh_GNSUM_analysis_disjoint$abs_error)
}
...
if(ncol(Nh_PIMLE_dataframe_disjoint) !=  0) {
  graph_data_mse_disjoint = cbind(graph_data_mse_disjoint, Nh_PIMLE =  Nh_PIMLE_analysis_disjoint$mse)
}
...
if(ncol(Nh_PIMLE_dataframe_disjoint) !=  0) {
  graph_data_sd_disjoint = cbind(graph_data_sd_disjoint, Nh_PIMLE =  Nh_PIMLE_analysis_disjoint$sd)
}
