...
simulation_data = read.csv("C:/Users/David Rabanedo/Downloads/Simulation_visibilityfactorestimate_reach_notdisjoint")


######### Data analysis ##########
# This way of presenting the data allows us to carry out a more detailed analysis
# of each estimator.
simulation_data_v =  select(simulation_data, -starts_with("vf_reach_out") & -starts_with("X") & -starts_with("data"))
simulation_data_v_out = select(simulation_data, starts_with("vf_reach_out"))
