...
sub_memory_factor = 0.15     # Subpopulation memory factor (parameter to change variance of the perturbations' normal)
memory_factor = 0.15         # Reach memory factor (parameter to change variance of the perturbations' normal)
