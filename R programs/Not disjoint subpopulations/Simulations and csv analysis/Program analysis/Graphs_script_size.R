...
simulation_data = read.csv("C:/Users/David Rabanedo/Downloads/Simulations_subpopulationsize_notdisjoint_comp (1)")
...
Nh_Direct_dataframe = dplyr::select(simulation_data, starts_with("Nh_Direct"))
...
ggplot(graph_data_abserror) + 
  #geom_point(aes(x = data, y =  Nh_basic_sum, col = "Nh_basic_sum")) + 
