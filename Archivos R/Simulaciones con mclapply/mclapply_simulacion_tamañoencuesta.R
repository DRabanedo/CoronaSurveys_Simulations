#############################################################################################################
# Simulaciones en función del valor del tamaño de la encuesta con mclapply, dejando el resto de cosas fijas
#############################################################################################################
...
tam_enc.simulaciones <- function(l,N, poblaciones_dis,v_probabilidades,PropHiddenPop, dim, nei, p, visibility_factor,
...
start_time = Sys.time()
lista_simulaciones =mclapply(1:25,tam_enc.simulaciones,N, poblaciones_dis,v_probabilidades,PropHiddenPop, dim, nei, p, visibility_factor,
                             memory_factor,sub_memory_factor,n_encuesta,n_encuesta_hp,iteraciones)
end_time = Sys.time()
...
write.csv(simulaciones,                    # Data frame a ser exportado
          file = "Simulaciones_tamanoencuesta", # Nombre de la hoja de Excel
