###################################################################################
# Graph based on the size of subpopulations, leaving the rest of parameters fixed
###################################################################################
...
x_0 = c("1-Same size", "2-Same size but smaller", "3-Different size", "4-Very different size")
x_1 = 1:4
ggplot() + 
  geom_line(aes(x = x_0, y =  Nh_basic, col = "Basic")) + 
