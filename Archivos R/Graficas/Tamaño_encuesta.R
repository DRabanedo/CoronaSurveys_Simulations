#########################################################################################
# Gráfica en función del valor del tamaño de la encuesta, dejando el resto de cosas fijas
#########################################################################################

#Datos para la simulación

N = 5000                  #Tamaño de la población general
...
iteraciones = seq(from = 1, to = 1000, length.out = 200)

#Generamos la población y la encuesta a la poblacion oculta
...
ggplot() + 
  ...
  #geom_line(aes(x = iteraciones, y =  Nh_Directo, col = "Nh_Directo")) +
